...
|[Testing JavaScript Applications](https://www.bookfinder.com/search/?author=Lucas+da+Costa&title=Testing+JavaScript+Applications&lang=en&st=xl&ac=qr)|📖 ✅|Disclaimer: I did not read the book... but I did read enough to get what I needed about E2E UI testing, so I'm counting it "done".  To be quite honest, I'm not sure if I'd recommend it or not!  It gave some great overview of different levels of testing, their purpose, and a high level comparison of types of tooling for browser automation (again, I was focusing on E2E UI tests).  However, the author really only went into detail about their preferred tools which was unfortunate. For sure worth a good skim for some context at the least!|
